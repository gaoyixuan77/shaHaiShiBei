...
- (void)viewDidLoad {
    ...
    scene.background.contents = [UIImage imageNamed:@"201703062123537509.jpg"];
    ...
    // 3. 加载模型文件
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:self.shallStr withExtension:@"usdz"];
